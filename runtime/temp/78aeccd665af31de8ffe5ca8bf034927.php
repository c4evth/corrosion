<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:94:"/Users/iimt/Development/PHP/corrosion/public/../application/admin/view/organization/index.html";i:1543994022;s:79:"/Users/iimt/Development/PHP/corrosion/application/admin/view/public/header.html";i:1544172502;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="layui-body">
	<div style="padding: 15px;">
		...
		<table class="layui-table">
			...
			<tbody>
				<?php if(is_array($Org) || $Org instanceof \think\Collection || $Org instanceof \think\Paginator): $i = 0; $__LIST__ = $Org;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<tr>
					<td style="text-align:center"><?php echo $vo['id']; ?></td>
					<td><?php echo $vo['Href']; ?></td>
					<td><?php echo $vo['name']; ?></td>
					<td style="text-align:center"><?php echo $vo['ballid']; ?></td>
					<td style="text-align:center">
						<?php echo $vo['cid']; ?>
					</td>
					<td style="text-align:center">
						<a href="/admin/Organization/editOrg?id=<?php echo $vo['id']; ?>" class="layui-btn layui-btn-warm layui-btn-mini">
							<i class="layui-icon">&#xe642;</i>编辑</a>
						<a href="/admin/organization/delOrg?id=<?php echo $vo['id']; ?>" class="layui-btn layui-btn-danger layui-btn-mini del">
