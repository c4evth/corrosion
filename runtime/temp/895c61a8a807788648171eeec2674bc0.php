<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:93:"/Users/iimt/Development/PHP/corrosion/public/../application/admin/view/organization/cate.html";i:1543993898;s:79:"/Users/iimt/Development/PHP/corrosion/application/admin/view/public/header.html";i:1544172502;}*/ ?>
<!DOCTYPE html>
<html>
		...
		<table class="layui-table">
			...
			<thead>
				<tr>
					...
					<th style="text-align:center">分类标识</th>
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align:center">
						<a href="/admin/Organization/editCate?id=<?php echo $vo['id']; ?>" class="layui-btn layui-btn-warm layui-btn-mini">
							<i class="layui-icon">&#xe642;</i>编辑</a>
						<a href="/admin/organization/delCate?id=<?php echo $vo['id']; ?>" class="layui-btn layui-btn-danger layui-btn-mini del">
