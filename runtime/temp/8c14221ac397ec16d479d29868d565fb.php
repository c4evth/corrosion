<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/Users/iimt/Development/PHP/corrosion/public/../application/admin/view/site/carousel.html";i:1541344052;s:79:"/Users/iimt/Development/PHP/corrosion/application/admin/view/public/header.html";i:1542238450;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="layui-body">
    <div style="padding: 15px;">
            <a href="/admin/site/addCarousel" class="layui-btn">添加</a>
        <table class="layui-table">
            ...
            <tbody>
                <?php if(is_array($carousels) || $carousels instanceof \think\Collection || $carousels instanceof \think\Paginator): $i = 0; $__LIST__ = $carousels;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    <td><?php echo $vo['id']; ?></td>
                    <td>
                        <img src="<?php echo $vo['img']; ?>">
                    </td>
                    <td><a href="<?php echo $vo['linkto']; ?>" target="_blank"><?php echo $vo['linkto']; ?></a></td>
                    <td>
                        <a href="/admin/site/editCarousel?id=<?php echo $vo['id']; ?>" class="layui-btn layui-btn-warm layui-btn-mini">
                            <i class="layui-icon">&#xe642;</i>编辑</a>
                        <a href="/admin/site/delCarousel?id=<?php echo $vo['id']; ?>" class="layui-btn layui-btn-danger layui-btn-mini del">
...
<script>
     layui.use('layer', function(){
        ...
        $(".del").on('click',function(){
            ...
            layer.confirm('确定要删除该吗?', {icon: 3, title:'温馨提示'}, function(index){
                location.href = url;
                layer.close(index);
            });
            return false;
