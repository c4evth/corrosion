<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"/Users/iimt/Development/PHP/corrosion/public/../application/admin/view/bdsrc/index.html";i:1542651814;s:79:"/Users/iimt/Development/PHP/corrosion/application/admin/view/public/header.html";i:1542238450;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="layui-body">
	<div style="padding: 15px;">
		...
		<form style="margin-top:20px;" enctype="multipart/form-data" action="/admin/bdsrc/dealImport?bdid=<?php echo $ID; ?>" method="POST">
		...
		<h1 style="padding-top: 15px;"><?php echo $parentData['name']; ?></h1>
		<table class="layui-table">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo $vo['search']; ?></td>
					<td style="max-width: 500px; display: inline-block; max-height: 100px; overflow-x: scroll; overflow-y: scroll;">
						<?php if($vo['type']==1): ?>
						<?php echo $vo['content']; else: ?>
						<img src="<?php echo $vo['content']; ?>">
						<?php endif; ?>
					</td>
					<td>
						<a href="/admin/bdsrc/edit?id=<?php echo $vo['id']; ?>" class="layui-btn layui-btn-warm layui-btn-mini">
							<i class="layui-icon">&#xe642;</i>编辑</a>
						<a href="/admin/bdsrc/del?id=<?php echo $vo['id']; ?>" class="layui-btn layui-btn-danger layui-btn-mini del">
