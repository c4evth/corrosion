<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"/Users/iimt/Development/PHP/corrosion/public/../application/admin/view/enlist/index.html";i:1544178350;s:79:"/Users/iimt/Development/PHP/corrosion/application/admin/view/public/header.html";i:1544172502;}*/ ?>
<!DOCTYPE html>
<html>
		...
		<table class="layui-table">
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align:center"><?php echo $vo['org']; ?></td>
					<td style="text-align:center"><?php echo $vo['bid']; ?></td>
					<td style="text-align:center"><?php if($vo['hasPaper'] == 0): ?>否<?php else: ?>是<?php endif; ?></td>
					<td style="text-align:center"><?php if($vo['isReport'] == 0): ?>否<?php else: ?>是<?php endif; ?></td>
					...
					<td style="text-align:center"><?php echo $vo['email']; ?></td>
					<td style="text-align:center">
						<a href="/admin/enlist/edit?id=<?php echo $vo['id']; ?>" class="layui-btn layui-btn-warm layui-btn-mini">
							<i class="layui-icon">&#xe642;</i>编辑</a>
						<a href="/admin/enlist/del?id=<?php echo $vo['id']; ?>" class="layui-btn layui-btn-danger layui-btn-mini del">
